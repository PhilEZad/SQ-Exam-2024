...
namespace HotelBooking.UnitTests
{
    public class BookingManagerTests
    {
        ...
        public void CreateBooking_Should_ReturnExpectedResult(int customerId, int startOffset, int endOffset, bool expectedResult)
        {
            ...
            if (expectedResult)
            {
                bookingRepository.Verify(repo => repo.Add(It.Is<Booking>(b => b.CustomerId == customerId && b.StartDate == newBooking.StartDate && b.EndDate == newBooking.EndDate && b.IsActive == true)), Times.Once);
            }
            else
            {
