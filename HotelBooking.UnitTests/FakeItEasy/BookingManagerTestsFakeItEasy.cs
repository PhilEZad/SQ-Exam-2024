...
namespace HotelBooking.UnitTests.FakeItEasy
{
    public class BookingManagerTestsFakeItEasy
    {
        private BookingManager bookingManager;
        private IRepository<Booking> bookingRepository;
        private IRepository<Room> roomRepository;

        public BookingManagerTestsFakeItEasy()
        {
        ...
        public void CreateBooking_Should_ReturnExpectedResult(int customerId, int startOffset, int endOffset, bool expectedResult)
        {
            ...
            if (expectedResult)
            {
                A.CallTo(() => bookingRepository.Add(A<Booking>.That.Matches(b =>
            ...
            {
                A.CallTo(() => bookingRepository.Add(A<Booking>.Ignored)).MustNotHaveHappened();
            }
        }
        ...
        private void SetupRooms()
        {
            ...
            A.CallTo(() => roomRepository.GetAll()).Returns(rooms);
        }

        private void SetupBookings(List<Booking> bookings)
        {
            A.CallTo(() => bookingRepository.GetAll()).Returns(bookings);
        }
    }
}
